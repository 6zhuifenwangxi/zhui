                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="user_name" placeholder="请输入运动员姓名" class="form-control"> 
                                </div>
                            </div>
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="state" placeholder="国籍" class="form-control">
                                </div>
                            </div>
                             <div class="form-group">
                                <label class="col-sm-3 control-label">执排手：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="hand" placeholder="执排手" class="form-control">
                                </div>
                            </div>
                             <div class="form-group">
                                <label class="col-sm-3 control-label">拿排方式：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="bat" placeholder="拿排方式" class="form-control">
                                </div>
                            </div>
                             <div class="form-group">
                                <label class="col-sm-3 control-label">打法：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="play" placeholder="打法" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
